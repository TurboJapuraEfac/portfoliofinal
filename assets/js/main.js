...
<footer class="webintern-footer">
    <div class="footer-left">
      ...
      <a href="https://www.linkedin.com/in/nimesh-buddhika-weerasinghe-8494a1109/" class="linkedin sub-footer-icon">
          <i class="fab fa-linkedin"></i>
      </a>
        <a href="https://github.com/TurboJapuraEfac" class="git sub-footer-icon">
          <i class="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/nimeshbuddhika" class="twitter sub-footer-icon">
